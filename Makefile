...
COMP_OPTS =  -sverilog -l vcs.log $(UVM) $(INCL) $(DEFINES) -timescale=1ns/1ps -full64 -debug_access+all
...
ifeq ($(MODE), RECORD)
		vcs $(COMP_OPTS)  \
        	 -debug_all ../tests/env_sv_eth_tb_mod.sv ../hdl/env_sv_eth_top.sv 
else		 
ifeq ($(MODE), DEBUG)
		vcs $(COMP_OPTS)  \
        	 -debug_all ../tests/env_sv_eth_tb_mod.sv ../hdl/env_sv_eth_top.sv 
		...
		vcs $(COMP_OPTS)  \
        	 ../tests/env_sv_eth_tb_mod.sv ../hdl/env_sv_eth_top.sv 
endif			 
endif		 
endif
...
help:
	@echo "****************************************************************"
	@echo "***   Makefile Help for env_sv_eth VIP :  					    ***"
	@echo "****************************************************************"
	@echo "*  Usage:                                                      *"
	@echo "*  ------                                                      *"
